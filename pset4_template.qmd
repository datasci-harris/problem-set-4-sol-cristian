...
zips_texas_with_distance_10.columns
...
zips_texas_with_distance.columns
zips_texas_with_distance.shape
# To estimate the time for this exercise
start_time = time.time()
...
```
It took: 676.96 seconds, which is at lest 100 seconds less than the estimation. 
...
### Question 5
```{python}
# pendiente, agrupar por zip code para sacer la distnancia promedio keeping variables para graficarlo
zips_texas_with_distance.groupby("ZIP_CD").size().reset_index()
zips_texas_with_distance.shape
